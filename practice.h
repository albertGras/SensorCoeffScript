...
/* Drive Target, !P!, !I!, Overshoot, FD Limit, A4, GasFD, A3 Limit, !Gas Slope!, !Gas Offst!, !Liq Slope!, !Liq Offst!, Minimum Flow Multiplier, !tempEffect!, !Flags! */
...
/* Tone Level, Ramp Time, BL Temp Coeff, Drive SP FCF, Puck P FCF, BL Temp Quad Coeff, dF Tone Spacing, Freq. Drift Limit, Max Sensor Current, T-series KFQ2, Drive SP */
...
//ID String,X,FCF,K1,X,X,TubeID, CAT, S_SMV, PressureEffect_Flow_Liquid, PressureEffect_Density, Zero Stability, X, X, MassFlowAccuracy_Liquid, MassFlowAccuracyMVD_Gas, DensityAccuracy_Liquid */
